...
import { ApplicationCommand, Client, ColorResolvable, EmbedField, GuildMember, Message, MessageEmbed, MessageEmbedFooter, MessageOptions, Role, Structures, TextBasedChannels, VoiceChannel } from "discord.js";
